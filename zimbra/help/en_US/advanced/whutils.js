...
function _getRelativePath(strParentPath,strCurrentPath)
{
	...
	while(nPathPos!=-1)
	{
		nPathPos=strParentPath.indexOf("../../../../index.html");
		if(nPathPos!=-1)
		{
...
function _getRelativeFileName(strParentPath,strCurrentPath)
{
	...
	for(var i=0;i<strParentPath.length&&i<strCurrentPath.length;i++) {
	    if (strParentPath.charAt(i) != strCurrentPath.charAt(i)) {
	        ...
	        if (strParentPath.charAt(i) == '../../../../index.html')
	            lastSlashIdx = i;
	    }
	}
...
{
	return (sPath.indexOf("../../../../index.html")==0);
}
...
function _getHost(sPath)
{
	...
	if(nPos>0)
	{
		var nPosx=sPath.indexOf("../../../../index.html",nPos+2);
		if(nPosx>0)
...
function _getFullPath(sPath,sRelPath)
{
	...
	else
	{
		...
		while(nPathPos!=-1)
		{
			var nPathPos=sRelPath.indexOf("../index.html");
			if(nPathPos!=-1)
			{
				sRelPath=sRelPath.substring(nPathPos+3);
				sFullPath=sFullPath.substring(0,sFullPath.length-1);
				var nPos2=sFullPath.lastIndexOf("../../../../index.html");
				if(nPos2!=-1)
...
{	
	var re=new RegExp("\\\\","g");
	var strReplacedURL=strURL.replace(re,"../../../../index.html");
...
function _getPath(strURL)
{
	...
	pathpos=strURL.lastIndexOf("../../../../index.html");
	if(pathpos>0)
...
function _isHTTPUrl(strUrl)
{
    ...
    str2 == "HTTPS://" || str2 == "zimbra_user_help.html\\\\")
        return true;
	else 
	{
...
function _isRemoteUrl(strUrl)
{
    ...
    if (str1 == "zimbra_user_help.html\\\\") return true;
...
function XmlJsReader() {
    ...
    this.loadScript = function (sScriptSrc, onScriptLoadedCB) {
        ...
        window.location.protocol === 'file:') {
            ...
            req.open('GET.html', scriptURL, true);
