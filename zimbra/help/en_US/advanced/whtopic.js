...
function UpdateBreadCrumbsMarker() {  
	if(gBreadCrumbInfo.length > 0)
	{
		...
		var sMasterDataPath = _getFullPath(sHomeFolder, "MasterData.html");
...
function GetMasterBreadcrumbs(sMasterDataPath) {
	...
	if(sMasterDataPath.indexOf("../../../../../../mergedProjects/index.html") == -1 &&
...
function onLoadingMasterDataXML(xmlDoc1, sMasterDataPath)
{
	...
	sMasterDataPath = _getFullPath(sMasterPath, "MasterData.html");
	GetMasterBreadcrumbs(sMasterDataPath);
}
...
function getPPStartPagePath(sPath)
{
	...
	{
		var sXmlFolderPath = _getPath(sPath);
		if(sXmlFolderPath.indexOf("../../../../../../mergedProjects/index.html") == -1 &&
			sXmlFolderPath.indexOf("\\mergedProjects\\") == -1)
        {
			return;
        }
		
		var sdocPath = _getFullPath(sXmlFolderPath, "MasterData.html");
        var sCurrentDocPath = _getPath(document.location.href);
...
function setRelStartPage(sPath)
{
	if(gsPPath.length==0)
	{
		...
		{
			alert("Error%20reading%20masterData.html");
		}
	}
}
...
function show()
{
	...
	if(gbBadUriError)
	{
		...
		var indx = strMainPage.toLowerCase().indexOf("../../../../../../mergedprojects/index-2.html");
		if(indx != -1)
...
function PickupDialog_Invoke()
{
	if(gbIE4 || gbNav6)
	{
		...
		{
			var sPickup="whskin_pickup.html";
